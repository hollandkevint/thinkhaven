...
interface MermaidBlockInnerProps {
  code: string
}

export default function MermaidBlockInner({ code }: MermaidBlockInnerProps) {
  ...
  useEffect(() => {
    ...
    async function render() {
      try {
        ...
        if (!cancelled) {
          // Sanitize SVG output — mermaid securityLevel:'strict' has had bypasses (CVE-2023-20052)
