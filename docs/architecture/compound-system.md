...
description: The single source of truth for the thinkhavenn Compound Learning System architecture.
...
This document is the **Single Source of Truth** for the Compound System's technical architecture. It maps the skills, workflows, scripts, and patterns that drive the autonomous engineering capability of thinkhavenn agents.
